...
| 4: actual-app vertical capture | PR #73 delivers a reviewed 18-second native recording with qualification, credits, preview/download and full restoration; 143 tests, lint/build, real H.264 export and complete browser playback verified | Physical iPhone/Safari; final deployment acceptance recorded in the task handoff |
