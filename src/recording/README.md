...
Full browser acceptance is pending for this inline adaptation. Previous schematic-recording evidence is not acceptance for this implementation. Required checks: a full 18-second native recording; playback of all three beats with the real Earth, Moon and sky; visible qualifications and credits; cancel during preparation and recording; foreground loss; custom camera and clock restoration; menu/focus restoration; reduced motion; and physical iPhone Safari. No clip is uploaded or published.
