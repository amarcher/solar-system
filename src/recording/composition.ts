...
export function paintRecordingFrame(
  ...
  context.fillText(RECORDING_CREDITS, 36, 1200);
  context.font = '14px Arial, sans-serif';
  context.fillText('solarsystemscope.com/textures · creativecommons.org/licenses/by/4.0', 36, 1220);
  backgroundCredits.forEach((line, index) => context.fillText(line, 36, 1240 + index * 18));
}
